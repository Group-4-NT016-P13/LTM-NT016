...
namespace ChessGame
{
    public class Board
    {
        ...
        //public bool IsInCheck(ChessPlayer player)
        //{
        //    Player equivalentPlayer = (Player)player; // Chuyển đổi kiểu

        //    return PiecePositionFor(equivalentPlayer.Opponent()).Any(pos =>
        //    {
